...
export type SectionDocumentUnion =
  | Posts_Document
  | Authors_Document
  | MarketingPages_Document
...
export type Article_Doc_FormFieldsUnion =
  | TextField
  | SelectField
  | TextareaField
...
export type MarketingPages_Document = Node &
  Document & {
...
export type LandingPage_Doc_FormFieldsUnion =
  | LandingPage_Blocks_BlocksField
  | TextareaField
