...
export type BlockPageFieldConfig_Component_Config =
  | TextFormField
  | BlocksFieldConfig;
...
export type SidecarFieldConfig_Component_Config =
  | TextFormField
  | ImageFormField
  | CtaFieldsListSidecarConfig
  | ActionsFieldConfig
  | SelectFormField;
...
export type ActionPageReferenceFieldConfig_Component_Config =
  | SelectFormField
  | ButtonSettingsFieldsListActionPageReferenceConfig;
...
export type ButtonSettingsFieldsListActionPageReferenceConfig = {
  ...
  component?: Maybe<Scalars["String"]>;
  fields?: Maybe<
    Array<Maybe<ButtonSettingsFieldsListActionPageReferenceConfigFields>>
  >;
};
...
export type ExcerptPostFieldConfig_Component_Config =
  | SelectFormField
  | TextFormField;
...
export type PriceListFieldConfig_Component_Config =
  | TextFormField
  | PricesFieldsListPriceListConfig;
...
export type PricesFieldsListPriceListConfigFields =
  | TextFormField
  | BulletPointsListPriceListPricesConfig
  | SelectFormField;
...
export type SponsorListFieldConfig_Component_Config =
  | TextFormField
  | SponsorFieldsListSponsorListConfig;
...
export type SponsorFieldsListSponsorListConfigFields =
  | TextFormField
  | ImageFormField;
...
export type PageReferenceFieldConfig_Component_Config =
  | TextFormField
  | SelectFormField;
...
export type SectionIndexFieldConfig_Component_Config =
  | TextFormField
  | SelectFormField;
...
export type ActionsUnion =
  | ActionVideoData
  | ActionNewsletterData
  | ActionPageReferenceData;
...
export type PostFieldConfig_Component_Config =
  | TextFormField
  | SelectFormField
  | ImageFormField
  | TagsFormField;
...
export type AuthorFieldConfig_Component_Config =
  | TextFormField
  | ImageFormField
  | AnecdotesListAuthorConfig
  | AccoladesFieldsListAuthorConfig;
...
export type MenuFieldConfig_Component_Config =
  | ImageFormField
  | MenuItemFieldsListMenuConfig;
...
export type MenuItemFieldsListMenuConfigFields =
  | TextFormField
  | SelectFormField;
...
export const useForestryForm2 = (props) => {
  return useForestryForm<DocumentUnion>(props);
};
