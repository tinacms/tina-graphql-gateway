...
const Home = (props) => {
  ...
  return (
    <>
      ...
      <hr />
      <h2>Post data</h2>
      <p>This is the post author data that we'd use for our actual page</p>
      <pre>
        <code>{JSON.stringify(postFake, null, 2)}</code>
      </pre>
      <hr />
      <h2>Author data</h2>
      <p>This is the resolved author data that we'd use for our actual page</p>
      <pre>
        <code>{JSON.stringify(authorFake, null, 2)}</code>
      </pre>
    </>
  );
};
...
const authorFake = {
  data: {
    document: {
      __typename: "Author",
      absolutePath: null,
      path: "content/authors/eric.md",
      content: "",
      excerpt: "",
      data: {
        _template: "AuthorFieldConfig",
        name: "Eric Avila",
        image: {
          path: "/uploads/5a505924-027b-4e4e-b2d3-8f852f5cbe89.jpg",
        },
        gallery: [
          {
            path: "/uploads/3.jpg",
