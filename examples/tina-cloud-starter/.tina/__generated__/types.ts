...
export type Posts_Data = Article_Data;

export type Posts_Input = {
  article?: Maybe<Article_Input>;
};

export type Posts_Values = Article_Values;

export type Posts_Form = Article_Form;
...
export type Article_FormFieldsUnion = TextField | TextareaField | SelectField;

export type Article_Form = {
  __typename?: 'Article_Form';
  label?: Maybe<Scalars['String']>;
  name?: Maybe<Scalars['String']>;
  fields?: Maybe<Array<Maybe<Article_FormFieldsUnion>>>;
};
...
export type Authors_Data = Author_Data;

export type Authors_Input = {
  author?: Maybe<Author_Input>;
};

export type Authors_Values = Author_Values;

export type Authors_Form = Author_Form;
...
export type MarketingPages_Data = LandingPage_Data;

export type MarketingPages_Input = {
  landingPage?: Maybe<LandingPage_Input>;
};

export type MarketingPages_Values = LandingPage_Values;

export type MarketingPages_Form = LandingPage_Form;
...
export type LandingPage_Data = {
  __typename?: 'LandingPage_Data';
...
export type LandingPage_Values = {
  __typename?: 'LandingPage_Values';
...
export type LandingPage_FormFieldsUnion = LandingPage_Blocks_BlocksField;

export type LandingPage_Form = {
  __typename?: 'LandingPage_Form';
  label?: Maybe<Scalars['String']>;
  name?: Maybe<Scalars['String']>;
  fields?: Maybe<Array<Maybe<LandingPage_FormFieldsUnion>>>;
};
